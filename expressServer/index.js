...
// const login = process.env.MT_LOGIN;
// const password = process.env.MT_PASSWORD;
// const server = process.env.MT_SERVER;
// const accountType = 'cloud-g2'; // o 'cloud-g1' según tu cuenta
// const application = 'MetaApi';
// const name = 'My MetaTrader Account';
...
//const region = process.env.REGION || "vint-hft";
